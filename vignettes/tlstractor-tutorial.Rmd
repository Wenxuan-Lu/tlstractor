...
1.  From the internal cohort, obtain the standard GWAS effect estimate $\hat{\beta}_1$ and standard error $se_1$, for example using PLINK2 or another GWAS software.

2.  From the external standard GWAS summary statistics, obtain the corresponding effect size estimate $\hat{\beta}_2$ and standard error $se_2$.
