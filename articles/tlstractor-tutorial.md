...
print(gds)
#> File: /tmp/RtmpaLa8BW/tlstractor_tutorial/linear/tracts/simulate_linear.flare.gds (3.5K)
#> +    [  ]
...
#> Munged summary statistics written to: /tmp/RtmpaLa8BW/tlstractor_tutorial/linear/munged_sumstats/external_gwas_sumstats_munged.txt
```
...
#> Scratch directory: /tmp/RtmpaLa8BW/tlstractor_tutorial/linear/results/tlstractor_linear_14128_20260703_045649_tmp
#> Output filepath: /tmp/RtmpaLa8BW/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
#> Initializing parallel cluster...
#> Running TLS-Tractor analysis in parallel...
#> Merging results...
#> Cleaning up temporary files...
#> TLS-Tractor analysis complete!
#> Results written to: /tmp/RtmpaLa8BW/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
```
