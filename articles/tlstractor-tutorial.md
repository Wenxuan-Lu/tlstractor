...
print(gds)
#> File: /tmp/RtmpDVmId8/tlstractor_tutorial/linear/tracts/simulate_linear.flare.gds (3.5K)
#> +    [  ]
...
#> Munged summary statistics written to: /tmp/RtmpDVmId8/tlstractor_tutorial/linear/munged_sumstats/external_gwas_sumstats_munged.txt
```
...
#> Scratch directory: /tmp/RtmpDVmId8/tlstractor_tutorial/linear/results/tlstractor_linear_14184_20260809_010035_tmp
#> Output filepath: /tmp/RtmpDVmId8/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
#> Initializing parallel cluster...
#> Running TLS-Tractor analysis in parallel...
#> Merging results...
#> Cleaning up temporary files...
#> TLS-Tractor analysis complete!
#> Results written to: /tmp/RtmpDVmId8/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
```
