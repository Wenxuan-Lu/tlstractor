...
#>  [4] "simulate_binary.meta.txt"                  
#>  [5] "simulate_binary.msp.tsv"                   
#>  [6] "simulate_binary.phased.vcf"                
#>  [7] "simulate_binary.pheno.txt"                 
#>  [8] "simulate_linear.covar.txt"                 
#>  [9] "simulate_linear.external_gwas_sumstats.txt"
#> [10] "simulate_linear.flare.vcf"                 
#> [11] "simulate_linear.meta.txt"                  
#> [12] "simulate_linear.msp.tsv"                   
#> [13] "simulate_linear.phased.vcf"                
#> [14] "simulate_linear.pheno.txt"
```
...
print(gds)
#> File: /tmp/RtmpbQKQUc/tlstractor_tutorial/linear/tracts/simulate_linear.flare.gds (3.5K)
#> +    [  ]
...
#> Munged summary statistics written to: /tmp/RtmpbQKQUc/tlstractor_tutorial/linear/munged_sumstats/external_gwas_sumstats_munged.txt
```
...
#> Scratch directory: /tmp/RtmpbQKQUc/tlstractor_tutorial/linear/results/tlstractor_linear_14325_20260809_005526_tmp
#> Output filepath: /tmp/RtmpbQKQUc/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
#> Initializing parallel cluster...
#> Running TLS-Tractor analysis in parallel...
#> Merging results...
#> Cleaning up temporary files...
#> TLS-Tractor analysis complete!
#> Results written to: /tmp/RtmpbQKQUc/tlstractor_tutorial/linear/results/tlstractor_linear.txt.gz
```
